                            ...
                            <div class="col-lg-9">
                                <div>
                                    <div class="text-center">
                                        ...
                                        <h4 class="font-size-18 mt-4">Реєстрація</h4>
                                    </div>
                                    ...
                                    <div class="p-2 mt-5">
                                        ...
                                        <?= $form->field($model, 'passwordConfirm', [
                                            ...
                                            'class' => 'form-control',
                                            'placeholder' => 'Введіть знову пароль',
                                        ]) ?>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p>Вже зареєстрований? <a href="<?= Url::to('/identity/login') ?>" class="font-weight-medium text-primary">Увійти</a> </p>
                                    </div>
                                </div>
