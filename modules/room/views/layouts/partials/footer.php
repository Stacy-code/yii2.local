            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footer--widget-about">
                    <div class="footer--widget-content">
                        <img class="mb-20" src="<?=Url::to('/themes/frontend/images/logo/logo-l.png')?>" alt="logo">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 footer--widget-contact">
                    ...
                    <div class="footer--widget-content">
                        <ul class="list-unstyled mb-0">
                            <li><i class="fa fa-map-marker"></i> Черкаси, Благовісна 262</li>
                            <li><i class="fa fa-phone"></i> +380 93 966 3400</li>
                            <li><i class="fa fa-envelope-o"></i>omen.barbershop.ck@gmail.com</li>
                        </ul>
